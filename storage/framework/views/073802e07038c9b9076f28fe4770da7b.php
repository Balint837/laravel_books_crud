...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input 
                            type="date" 
                            class="form-control <?php $__errorArgs = ['publishedDate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                            id="publishedDate" 
                            name="publishedDate" 
                            value="<?php echo e(old('publishedDate')); ?>">
                        <?php $__errorArgs = ['publishedDate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?>
<?php /**PATH E:\School\13A\Orai\Laravel\2024.12.19\20241209_QueryBulider_Library\resources\views/books/create.blade.php ENDPATH**/ ?>