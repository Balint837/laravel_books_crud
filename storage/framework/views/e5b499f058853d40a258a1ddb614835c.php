...
unset($__errorArgs, $__bag); ?>" id="author"
                name="author" value="<?php echo e(old('author')); ?>">
            <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="published_year"
                name="published_year" value="<?php echo e(old('published_year')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="category_id" name="category_id">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($category->id); ?>" <?php if($category->id == old('category_id')): ?> selected <?php endif; ?>>
...
<?php endif; ?>
<?php /**PATH D:\13a_Laravel\202041209_QueryBulider_Library\resources\views/books/create.blade.php ENDPATH**/ ?>